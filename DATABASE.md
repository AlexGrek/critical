...
## Planned Collections (not yet active)

| Collection | Notes |
|-----------|-------|
| `projects` | Will act as namespaces for namespaced resources. No special ID prefix (plain identifiers). Pending namespace rework. |
